...
Plans:
- [ ] 02.5-01-PLAN.md — Wave 0: lint/typecheck gate + production start fix (D-03, D-10)
- [ ] 02.5-02-PLAN.md — Wave 0: baseline drizzle migration flow, retire db:push for prod (D-05, D-06)
- [ ] 02.5-03-PLAN.md — Wave 1: GitHub Actions CI workflow + branch protection on main (D-03, D-04)
- [ ] 02.5-04-PLAN.md — Wave 1: env-driven CORS allowlist + Clerk authorizedParties + env contract (D-02, D-08, D-09)
...
- [x] 02.4-02-PLAN.md — Cross-tenant PATCH /listings/:id brandId guard + email HTML/CRLF injection escaping (D-12, D-11)
- [x] 02.4-03-PLAN.md — Destructive-seed production guard + upload content-type allowlist & 5MB presigned-POST size cap (D-08, D-06, D-07)
...
- [x] 02.4-06-PLAN.md — Final manual UAT checkpoints: DB constraints, role gating, end-to-end upload
...
- [x] 02.3-04-PLAN.md — Automated gates + manual UAT verification checkpoint (web tests deferred)
...
Plans:
- [x] 02.2-01-PLAN.md — Zod schema validation tests (21 stubs) + seed data constant/structural tests (7 stubs)
- [x] 02.2-02-PLAN.md — Brand route handler tests (17 stubs) + category route handler tests (13 stubs)
- [x] 02.2-03-PLAN.md — Listing route handler tests (22 stubs) + upload route handler tests (5 stubs)
...
| 2.2. Populate Phase 2 test stubs | 3/3 | Complete   | 2026-03-09 |
